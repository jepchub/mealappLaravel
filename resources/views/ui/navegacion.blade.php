...
<a href="{{ route('perfiles.edit',['perfil' => Auth::user()->id]) }}" class="btn btn-outline-success mr-2 mt-2 text-uppercase font-weight-bold">
...
<a href="{{ route('perfiles.show',['perfil' => Auth::user()->id]) }}" class="btn btn-outline-info mr-2 mt-2 text-uppercase font-weight-bold">
