    ...
    <form class="container h-100" action="{{route('buscar.show')}}" >
      <div class="row h-100 align-items-center">
        <div class="col-md-4 texto-buscar">
          <p class="display-4">Encuentra una recera para tu próxima comida</p>
          <input
            type="search"
            name="buscar"
            class="form-control"
...
@section('content')
  {{-- <img src="{{asset('images/bgimagen.jpg')}}" alt="imagen fondo"> imagen estatica --}}
  {{-- <img src="{{urk('images/bgimagen.jpg')}}" alt="imagen fondo"> --}}
      ...
      @foreach($nuevas as $nueva)
        <div class="card">
          ...
          <div class="card-body">
            ...
            {{-- <h3>{{Str::ucfirts($nueva->titulo)}}</h3> --}}
            ...
            <a href="{{route('recetas.show', ['receta' => $nueva->id])}}"
                class="btn btn-outline-success d-block font-weight-bold text-uppercase"
            >Ver Receta</a>
          </div>
        </div>
      @endforeach
